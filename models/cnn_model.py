...
from tensorflow.keras.layers import Conv1D, GlobalMaxPooling1D, Dense, Dropout, Input # type: ignore
...
def train_cnn_model(X, Y, M, timestamps, feat_sensor_names, label_names, sensors_to_use, target_label,
    ...
    print(f"== Training CNN with {X_win.shape[0]} windows for label '{get_label_pretty_name(target_label)}'")
...
def test_cnn_model(X, Y, M, timestamps, feat_sensor_names, label_names, model,
                   window_size=20, step_size=10):
