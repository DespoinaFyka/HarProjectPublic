...
def train_lstm_model(X, Y, M, timestamps, feat_sensor_names, label_names, sensors_to_use, target_label,
    ...
    print(f"== Training LSTM with {X_win.shape[0]} windows for label '{get_label_pretty_name(target_label)}'")
...
def test_lstm_model(X, Y, M, timestamps, feat_sensor_names, label_names, model,
                    window_size=20, step_size=10):
    ...
    X_win, y_win, t_win = extract_sliding_windows(X, Y, M, timestamps,
                                              label_ind=label_ind,
