...
from models.logistic_regression_model import train_logistic_regression_model, test_logistic_regression_model
...
RESULTS_FOLDER = os.path.join(WORKING_DIR, "results", "logistic_regression")
...
for TARGET_LABEL in LABELS:
    ...
    for fold_idx in range(5):
        ...
        feat_sensor_names = get_sensor_names_from_features(train_users[0].feature_names)
        ...
        metrics = test_logistic_regression_model(
