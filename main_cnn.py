...
from models.cnn_model import test_cnn_model, train_cnn_model
...
RESULTS_FOLDER = os.path.join(WORKING_DIR, "results", "cnn")
...
for TARGET_LABEL in LABELS:
    ...
    for fold_idx in range(5):
        ...
        model = train_cnn_model(
            X_train, Y_train, M_train, timestamps, 
